...
$use_auth = true;
$auth_users = array(
    'kominfo' =>'$2y$10$bhrofgkGzkWMD8DJT5p69etuNTg17Y3WTwDb4KtJZcfFj/D0uUTyq', 
);
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            ...
                            &mdash;&mdash; &copy;
                            <a href="https://www.kominfo.go.id" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">Kominfo</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
